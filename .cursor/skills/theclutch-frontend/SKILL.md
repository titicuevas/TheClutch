---
name: theclutch-frontend
description: >-
  Builds TheClutch mobile-first UI: career screens, events, season report,
  legacy card, accessibility. Use when editing React/Next components, styles,
  or player-facing navigation.
---
...
6. No diseñes 82 box scores ni menús de franquicia.
